  ...
  describe('exportOpenData - JSON Format', () => {
    it('should export products as JSON', async () => {
      const products = [
        ...
        createMockProduct('1234567890123'),
      ];
      mockStorage['open_data_products'] = JSON.stringify(products);
  ...
  describe('exportOpenData - Filtering', () => {
    ...
    it('should filter by quality score', async () => {
      const products = [
        ...
        { ...createMockProduct('3333333333333'), qualityScore: 0.50 },
      ];
      mockStorage['open_data_products'] = JSON.stringify(products);
    ...
    it('should combine multiple filters', async () => {
      const products = [
        ...
        { ...createMockProduct('3333333333333', 'MQ', '2025-06-01T00:00:00Z'), qualityScore: 0.90 },
        { ...createMockProduct('4444444444444', 'GP', '2025-06-01T00:00:00Z'), qualityScore: 0.60 },
      ];
      mockStorage['open_data_products'] = JSON.stringify(products);
